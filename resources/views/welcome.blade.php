...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72">
    ...
    <section style="display: flex;flex-direction: row;align-items: center;padding-left: 120px;padding-right: 120px;align-content: center;justify-content: center; width: -webkit-fill-available;">
        <div style="width: -webkit-fill-available">
            <div class="container" style="display: flex;flex-direction: column;align-content: space-between;justify-content: center;">
                <div class="text-white bg-brand border rounded border-0" style="width: -webkit-fill-available;padding: 80px 120px">
                ...
                <div class="container bg-dark border rounded border-0 p-4 p-md-5" id="map" style="width: -webkit-fill-available; height: 600px;"></div>
            </div>
        </div>
    </section>
    {{-- Section Payment --}}

    <section style="display: flex;flex-direction: row;align-items: center;padding-left: 120px;padding-right: 120px;align-content: center;justify-content: center;">
        <div class="row" style="display: flex;flex-direction: column;align-items: flex-start;padding: 80px 120px;gap: 80px;width: 1440px;height: 904px;background: #FFFFFF;align-content: center;justify-content: center;">
            <div class="row"
    ...
    <section style="display: flex;flex-direction: row;align-items: center;padding-left: 120px;padding-right: 120px;align-content: center;justify-content: center;">
        <div style="width: -webkit-fill-available;height: 910px;background: #F9FAFB;">
            <div class="row" style="display: flex;flex-direction: column;align-items: center;">
                ...
                <div class="col" style="display: flex;flex-direction: row;align-items: flex-start;padding: 80px 120px 80px 674px;isolation: isolate;position: absolute;">
          ...
          {{-- <a class="btn btn-primary" data-bs-toggle="modal" href="#modalPengaduan" role="button">Lapor</a> --}}
    ...
    <section style="display: flex;flex-direction: row;align-items: center;align-content: center;justify-content: center;">
        <div style="background-color: #F9FAFB;display: flex;flex-direction: row;justify-content: center;align-items: center;align-content: center;padding: 10px 120px;gap: 80px;width: -webkit-fill-available;height: 120px;">
                ...
                <div class="row align-items-center h-100">
                    <div class="container rounded">
                        <div class="slider" style="animation: slidein 30s linear infinite;white-space: nowrap;">
                            <div class="logos" style="width: 70%;display: inline-block;margin: 0px 0;">
    ...
    <section style="display: flex;flex-direction: row;align-items: center;align-content: center;justify-content: center;">
        <footer class="text-white" style="background-color: #AF2330; display: flex;display: flex;flex-direction: column;align-items: flex-start;padding: 0px;width: -webkit-fill-available;height: 398px;">
            <div class="col" style="display: flex;flex-direction: column;align-items: flex-start;padding: 40px 120px;gap: 40px;width: -webkit-fill-available;height: 338px;">
                ...
                <div class="row" style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 80px;width: -webkit-fill-available;height: 170px;justify-content: space-between;">
                    <div class="col-auto"
            ...
            <div class="d-flex justify-content-between align-items-center pt-3"
                style="background-color: #921D28;display: flex;flex-direction: row;padding: 20px 120px;width: -webkit-fill-available;height: 60px;">
