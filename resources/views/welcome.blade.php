...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72">
        ...
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                <span class="d-flex justify-content-center align-items-center me-2">
                    <img class="border rounded" src="{{ asset('assets/img/tsmgLogo32px-01.png') }}" width="36"
                        height="36">
                </span>
    ...
    <div class="slicktsm single-item">
        <div class="slickitem">
            <div class="slickbg"
                style="background: url('{{ asset('assets/img/Hero.png') }}') top center / 100% auto no-repeat;">
                <div class="slickbody">
                    <div class="headerbanner" style="max-width: 100%;">
                        ...
                        <p class="fssldier2">Download aplikasi<br>
                            ...
                            info lokasi bus terkini<br> serta lainnya.</span>
                        </p>
        ...
        <div class="headinfomaps">
            <div class="infowrap">
                <div class="infotext">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit orci condimentum natoque elit amet
                        mauris augue sed nunc. Consequat tincidunt risus nulla viverra. Massa sollicitudin dui
                        adipiscing massa. </p>
                </div>
            </div>
        </div>
        ...
        <div class="fliprute">
            ...
            <a class="btnflip" href="javascript:btnrute();">
                <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                    ...
                    <path
                        d="M3 9C3 9.55228 3.44771 10 4 10C4.55228 10 5 9.55228 5 9L5 3.41421L6.29289 4.70711C6.68342 5.09763 7.31658 5.09763 7.70711 4.70711C8.09763 4.31658 8.09763 3.68342 7.70711 3.29289L4.70711 0.292893C4.51957 0.105357 4.26522 0 4 0C3.73478 0 3.48043 0.105357 3.29289 0.292893L0.292893 3.29289C-0.0976311 3.68342 -0.0976311 4.31658 0.292893 4.70711C0.683417 5.09763 1.31658 5.09763 1.70711 4.70711L3 3.41421L3 9Z"
                        fill="#AF2330" />
                    <path
                        d="M13 5C13 4.44772 12.5523 4 12 4C11.4477 4 11 4.44772 11 5L11 10.5858L9.70711 9.29289C9.31658 8.90237 8.68342 8.90237 8.29289 9.29289C7.90237 9.68342 7.90237 10.3166 8.29289 10.7071L11.2929 13.7071C11.4804 13.8946 11.7348 14 12 14C12.2652 14 12.5196 13.8946 12.7071 13.7071L15.7071 10.7071C16.0976 10.3166 16.0976 9.68342 15.7071 9.29289C15.3166 8.90237 14.6834 8.90237 14.2929 9.29289L13 10.5858L13 5Z"
                        fill="#AF2330" />
                </svg>
            </a>
        </div>
        ...
        <div class="cardwrap">
            <div class="row cardhead">
                ...
                <div class="col text-justify cardheadh1-ket">
                    ...
                    pulvinar vitae sit proin. Quam morbi turpis dolor in.</div>
            </div>
            <div class="swiper">
        ...
        <div class="col rcwrapper">
            <div class="rcleft">
                <div class="rclefttitle">
                    ...
                    <p class="tslayanan">Layanan<strong style=" font-weight: 800;color: #AF2330;">Aduan<br>&
                            Bantuan</strong></p>
                </div>
                <div class="tslistwrap">
                    ...
                    <div class="tslist">
                        ...
                        <div class="tsnumlistwrap">
                            ...
                            <p class="listcont">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sed est
                                lorem massa. Risus in faucibus amet laoreet diam. </p>
                        </div>
                    </div>
                    <div class="tslist">
                                ...
                                <div class="mb-3 insideformwrap">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="Default select example" required>
                                            ...
                                            <option value="1">1.Pelanggaran terhadap kode etik dan/atau pedoman
                                                perilaku aparat</option>
                                            <option value="2">2.Penyalahgunaan wewenang/jabatan</option>
                                            <option value="3">3.Pelanggaran sumpah jabatan</option>
                                            <option value="4">4.Pelanggaran terhadap peraturan disiplin Pegawai
                                                Negeri Sipil</option>
                                            <option value="5">5.Perbuatan tercela, yaitu perbuatan amoral,
                                                asusila, atau perbuatan yang tidak selayaknya dilakukan oleh seorang
                                                aparat maupun selaku anggota masyarakat</option>
                                            <option value="6">6.Pelanggaran hukum, baik dilakukan dengan sengaja,
                                                maupun karena kelalaian dan ketidakpahaman</option>
                                            <option value="7">7.Mal administrasi, yaitu terjadinya kesalahan,
                                                kekeliruan atau kelalaian yang bersifat administratif</option>
                                            <option value="8">8.Pelayanan publik yang tidak memuaskan yang dapat
                                                merugikan pihak-pihak yang berkepentingan serta masyarakat secara umum
                                            </option>
                                        </select>
                    ...
                    @else
                        <div class="row lgnfirst">
                            <div class="lgnfirstwrap1">
                                ...
                                <div class="mb-3 lgnfirstwrap2">
                                    ...
                                    <div class="mb-3 GPlusSignIn">
                                        <a href="/auth/google" class="btn GPlusSignIn" role="button"
                                            type="button">
                            ...
                            <div class="mb-3 lgnfirsth2text">
                                <p class="lgnfirsth2text2">Setelah Anda mengajukan keluhan, kami akan mengirimkan
                                    informasi penanganan ke email yang Anda gunakan untuk login.</p>
                            </div>
                        </div>
                @endif
            </div>
        ...
        <div class="col reporttrackingwrap">
            <div class="row reporttrackingwrap1">
                ...
                <div class="reporttrackingwrap1right">
                    <a href="#modalPengaduan" data-bs-toggle="modal" class="btn reporttrackingwrap1rightbtn"
                        role="button">
                        <img src="https://cdn.cdnlogo.com/logos/g/35/google-icon.svg">
    ...
    <div class="modal modal-xl fade" id="modalPengaduan" aria-hidden="true" aria-labelledby="modalPengaduanLabel"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-scrollable"
            style="filter: drop-shadow(0px 4px 12px rgba(29, 41, 57, 0.12));">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title fs-5 trck" id="modalPengaduanLabel" style="">Detail
                        Complaint</label>
                                ...
                                <div class="d-flex mb-1">
                                    ...
                                    <div>
                                        ...
                                        <q class="lead text-muted pb-3">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Scelerisque sed
                                            erat leo ullamcorper est. Nibh eget.
                                        </q>
                                    </div>
                                </div>
                                <div class="d-flex mb-1">
                        ...
                        <div class="row modalwrapright">
                            <div class="card border-secondary mb-5 modalwrapright1">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted cbt">Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit. Dictumst dolor arcu eleifend in. Enim enim fringilla.</p>
                                </div>
        ...
        <footer class="text-white">
            <div class="row footerr1">
                <div class="col-auto footerr1c1">
                    ...
                    <p class="ftrtext2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse et
                        malesuada lobortis quis.</p>
                    <div class="ftrlogodn">
                        <a href="https://play.google.com/store/apps/details?id=ngi.brtsemarang.apppublic"
                            target="_blank"><img src="assets/img/Google_Play.png"></a>
                        <a href="https://apps.apple.com/id/app/trans-semarang/id1460565652" target="_blank"><img
                                src="assets/img/App_Store.png"></a>
                    </div>
                </div>
                ...
                <div class="btmwrap justify-content-between align-items-center">
                    ...
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                            <a href="https://www.facebook.com/bus.trans.semarang/" target="_blank"
                                style="color: #ffffff">
                        ...
                        <li class="list-inline-item">
                            <a href="https://www.youtube.com/channel/UCeaDUObnYHFxrdsea9zIP3w" target="_blank"
                                style="color: #ffffff">
