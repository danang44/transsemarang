...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72">
    ...
    <footer class="text-white" style="background-color: #AF2330">
        <div class="col" style="padding-top: 40px;padding-bottom: 40px;padding-left: 120px;padding-right: 120px;">
            <div class="row text-lg-start d-flex flex-column item" style="display: flex;flex-direction: row;justify-content: space-between;align-items: flex-start;padding: 0px;width: 1200px;height: 48px;padding-bottom: 40px;">
