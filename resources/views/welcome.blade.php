...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72">
    <header>
        <nav id="mainNav" class="navbar navbar-light navbar-expand-lg py-3 shadow fixed-top"
            style="background: linear-gradient(#ffffff, white), #ffffff;padding-right: 120px;padding-left: 120px;">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="#home">
                    <span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon">
                        <img class="border rounded" src="assets/img/tsmgLogo32px-01.png" width="36" height="36">
                    </span>
                    <img src="assets/img/logotsmg.png" width="198.87" height="44">
                </a>
                ...
                <div id="navbarResponsive" class="collapse navbar-collapse" id="navcol-2">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded" href="https://www.instagram.com/transsemarang/" target="_blank">
                                <img src="assets/img/Social icon.svg" alt=""></a>
                        </li>
                        <li class="nav-item mx-0 mx-lg-1">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded" href="https://twitter.com/transsemarang" target="_blank">
                                <img src="assets/img/Social icon-1.svg" alt=""></a>
                        </li>
                        <li class="nav-item mx-0 mx-lg-1">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded" href="https://www.youtube.com/channel/UCeaDUObnYHFxrdsea9zIP3w" target="_blank">
                                <img src="assets/img/Social icon-2.svg" alt=""></a>
                        </li>
                    </ul>
    ...
    <section style="background: url('assets/img/Hero.png')center / cover no-repeat;position: relative;width: 100%;padding-bottom: 120px;padding-top: 120px">
            ...
            <div class="row">
                <div class="col-md-6 text-left text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center" style="color: #ffffff">
                    <div style="max-width: 600px;">
                        <p>
                            <span style="font-size:45px;font-family: 'Plus Jakarta Sans';">Download aplikasi<br><strong>Trans Semarang</strong>, dapatkan<br>info lokasi bus terkini<br> serta lainnya.</span>
                        </p>
                        {{-- <p>
                            <span style="font-size:45px;font-family:tahoma,geneva,sans-serif;"><strong>Trans Semarang</strong>, dapatkan<br></span>
                        </p>
                        <p>
                            <span style="font-size:45px;font-family:tahoma,geneva,sans-serif;">info lokasi bus terkini serta lainnya.</span>
                        </p> --}}
                        <p class="my-1">Tincidunt laoreet leo, adipiscing taciti tempor. Primis senectus sapien,
                            risus donec ad fusce augue interdum.</p>
                            <a class="btn me-2" role="button" href="https://play.google.com/store/apps/details?id=ngi.brtsemarang.apppublic" target="_blank" style="background: url('assets/img/Google_Play.png')  center / cover repeat;width: 162px;height: 48px;"></a>
                            <a class="btn" role="button" href="https://apps.apple.com/id/app/trans-semarang/id1460565652" target="_blank" style="background: url('assets/img/App_Store.png')  center / cover repeat;width: 162px;height: 48px;"></a>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <section>
        <section class="py-4 py-xl-5">
            ...
            <div class="container bg-dark border rounded border-0 p-4 p-md-5" id="map" style="width: auto; height: 600px;"></div>
            <script>
