...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Plus+Jakarta+Sans:200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i&amp;subset=cyrillic-ext,latin-ext,vietnamese&amp;display=swap">
    ...
    <body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72">
        <header>
            <nav id="mainNav" class="navbar navbar-light navbar-expand-lg py-3 shadow fixed-top" style="background: linear-gradient(#ffffff, white), #ffffff;min-height: 88px;padding-top: 20px;padding-bottom: 20px;padding-right: 120px;padding-left: 120px;">
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="#home">
                        <span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon">
                            <img class="border rounded" src="assets/img/tsmgLogo32px-01.png" width="32" height="32">
                        </span>
                            <span class="fw-bolder">TRANS SEMARANG</span></a>
                    ...
                    <div id="navbarResponsive" class="collapse navbar-collapse" id="navcol-2">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item mx-0 mx-lg-1">
                                <a class="nav-link py-3 px-0 px-lg-3 rounded" href="https://www.instagram.com/transsemarang/" target="_blank"><img src="assets/img/Social icon.svg" alt=""></a>
                            </li>
                            <li class="nav-item mx-0 mx-lg-1">
                                <a class="nav-link py-3 px-0 px-lg-3 rounded" href="https://twitter.com/transsemarang" target="_blank"><img src="assets/img/Social icon-1.svg" alt=""></a>
                            </li>
                            <li class="nav-item mx-0 mx-lg-1">
        ...
        <section>
            ...
            </section><iframe allowfullscreen="" frameborder="0" src="https://cdn.bootstrapstudio.io/placeholders/map.html" width="100%" height="400"></iframe>
        </section>
        <section>
            <div class="container py-4 py-xl-5">
                <div class="row mb-5">
        ...
        <section><div>
        <h1 class="text-center text-h1 margin-bot">Partners </h1></div>
    
    <div class="customer-logos">
      <div class="slide"><img style="margin-top:1.5em;" src="dell.png"></div>
      <div class="slide"><img style="margin-top:1.3em;" src="emc.png"></div>
      <div class="slide"><img src="equinix.png"></div>
      <div class="slide"><img style="margin-top:2em;" src="microsoft.png"></div>
      <div class="slide"><img style="margin-top:2em;" src="nutanix.png"></div>
      <div class="slide"><img style="margin-top:1.4em;"src="simplivity.png"></div>
      <div class="slide"><img style="margin-top:2em;"src="vmware.png"></div>
    </div>
