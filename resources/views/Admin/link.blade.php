            ...
            <div class="card mb-5">
                <div class="page-header-content header-elements-md-inline" style="background-color:#011126">
                    <div class="page-title d-flex" style="padding-top:1% !important;padding-bottom:1% !important">
                        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Data Link</h4>
                    ...
                    <div class="header-elements d-none py-0 mb-3 mb-md-0">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Data Link</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                        ...
                        <div class="pt-2 pr-1 pl-1 table-responsive col-sm-12 ">
                            <table id="table_id" class="table table-striped  table-striped table-border m-1 datatable-scroll-y">
                                ...
                                <tbody>
                                    @foreach($link as $c)
                                    <tr>
                                        <td class="pr-2 pl-1 "><img width="300px" src="{{ url('/data_link/'.$c->image) }}"></td>
                                        <td class="pr-2 pl-2 ">{{$c->title}}</td>
                                        <td class="pr-2 pl-2 ">{{$c->link}}</td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/link_store" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <label>Link</label>
                        <input type="text" required="required" class="form-control" name="link" id="link">
                    </div>
                    <div class="form-group">
